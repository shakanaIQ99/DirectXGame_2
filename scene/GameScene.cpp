...
void GameScene::Update() {
	...
	if (input_->PushKey(DIK_W)) {
		worldTransform_[PartID::Root].translation_.y += kChestRotSpeed;
	}
	...
	viewProjection_.eye.x = worldTransform_[PartID::Root].translation_.x + (-result.x * 20);
	
	viewProjection_.eye.z = worldTransform_[PartID::Root].translation_.z + (-result.z * 20);
	
	
	viewProjection_.target.x = worldTransform_[PartID::Root].translation_.x;
	viewProjection_.target.y = worldTransform_[PartID::Root].translation_.y;
	viewProjection_.target.z = worldTransform_[PartID::Root].translation_.z;
